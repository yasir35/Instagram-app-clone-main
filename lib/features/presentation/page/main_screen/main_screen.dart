        ...
        if (getSingleUserState is GetSingleUserLoaded) {
          ...
          return Scaffold(
            ...
            bottomNavigationBar: CupertinoTabBar(
              backgroundColor: backGroundColor,
              items: [
                BottomNavigationBarItem(icon: Icon(FontAwesomeIcons.home, color: primaryColor), label: ""),
                BottomNavigationBarItem(icon: Icon(FontAwesomeIcons.magnifyingGlass, color: primaryColor), label: ""),
                BottomNavigationBarItem(icon: Icon(FontAwesomeIcons.circlePlus, color: primaryColor), label: ""),
